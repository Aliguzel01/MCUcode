...
/*
 * ARM CORTEX MX İŞLEMCİ NUMARASI,ÖNCELİK kaydında uygulalan öncelikli bit sayısı
 */
...
/*flash ve sram in baslangıc adresleri*/
#define FLASH_BASEADDR                         0x08000000U
#define SRAM1_BASEADDR                         0x20000000U  //112KB
#define SRAM2_BASEADDR                         0x2001C000U
#define ROM_BASEADDR                           0x1FFF0000U  //SYSTEM MEMORY 30KB
#define SRAM                                   SRAM1_BASEADDR   /*SRAM1 ana sram olarak kabıl edilir*/
...
/*
 * AHB1 veri yoluna asılı olan cevre birimlerinin addreslerini tanımlayalım
 */
...
/*
 * APB1 veri yoluna asılı olan cevre birimlerinin addreslerini tamamlayalım
 */
...
/*
 * APB2 veri yoluna aslı olan cevre birimlerinin temel adreslerini tanımlayalım
 */
...
/*
 * cevresel kayıtların STRUCT yapıları
 */

typedef struct
{
	__vo uint32_t MODER;          /*addres offset 0x00*/
	__vo uint32_t OTYPER;         /*addres offset 0x04*/
...
/*
 * EXTI İCİN CEVRESEL KAYIT YAPISI
 */
...
/*
 * SPI için çevresel kayıt tanımlama yapısı
 */

typedef struct
{
	__vo uint32_t CR1;       /*  Adres uzaklığı: 0x00  */
	__vo uint32_t CR2;         /*  Adres uzaklığı: 0x04  */
	__vo uint32_t SR;          /*  Adres uzaklığı: 0x08  */
	__vo uint32_t DR;           /*  Adres uzaklığı: 0x0C  */
	__vo uint32_t CRCPR;       /*  Adres uzaklığı: 0x10  */
	__vo uint32_t RXCRCR;          /*  Adres uzaklığı: 0x14  */
	__vo uint32_t TXCRCR;     /*  Adres uzaklığı: 0x18  */
	__vo uint32_t I2SCFGR;      /*  Adres uzaklığı: 0x1C  */
	__vo uint32_t I2SPR;         /*  Adres uzaklığı: 0x20  */
...
/*
 * I2C için çevresel kayıt tanımlama yapısı
 */
typedef  struct
{
  __vo uint32_t CR1;        /*  Adres uzaklığı: 0x00 */
  __vo uint32_t CR2;        /*  Adres uzaklığı: 0x04 */
  __vo uint32_t OAR1;       /*   Adres uzaklığı: 0x08 */
  __vo uint32_t OAR2;       /*   Adres uzaklığı: 0x0C */
  __vo uint32_t DR;         /*   Adres uzaklığı: 0x10 */
  __vo uint32_t SR1;        /*  Adres uzaklığı: 0x14 */
  __vo uint32_t SR2;        /*  Adres uzaklığı: 0x18 */
  __vo uint32_t CCR;        /*   Adres uzaklığı: 0x1C */
  __vo uint32_t TRISE;      /*   Adres uzaklığı: 0x20 */
  __vo uint32_t FLTR;       /*   Adres uzaklığı: 0x24 */
} I2C_RegDef_t;
...
/*
 * cevresel tanımlar(xxx_RegDef_t ye yazılan cevresel temel adresler
 */
...
/*
 * CLOCK DİSABLE MACROS FOR GPIOx PERIPHERALS
 */
...
/*
 * CLOCK DİSABLE MACROS FOR I2Cx PERIPHERALS
 */
...
/*
 * CLOCK DİSABLE MACROS FOR SPIx PERIPHERALS
 */
...
/*
 * CLOCK DİSABLE MACROS FOR USARTx PERIPHERALS
 */
...
/*
 * CLOCK DİSABLE MACROS FOR SYSCFGx PERIPHERALS
 */
...
/*
 * GPIOx sıfırlama(reset) makroları
 */
...
/*
 * GPIOx TEMEL adresleri için portcode döndürme
 */

//0 ile 7 arasındaki degerdeki portları ele aldım
...
/*
 * olası tüm öncelik seviyeleri için makrolar
 */
...
/*
 * bit position definnitions SPI_CR1
 */
...
/*
 * bit position definnitions SPI_CR2
 */
...
/*
 * bit position definnitions SPI_SR
 */
